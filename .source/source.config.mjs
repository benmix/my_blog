...
// src/styles/flexoki-dark.json
var flexoki_dark_default = {
  name: "Flexoki",
  type: "dark",
  colors: {
...
// src/styles/flexoki-light.json
var flexoki_light_default = {
  name: "Flexoki",
  type: "light",
  colors: {
...
var source_config_default = defineConfig({
  mdxOptions: {
    ...
    rehypeCodeOptions: {
      themes: {
        light: flexoki_light_default,
        dark: flexoki_dark_default
      },
      lazy: false,
      defaultColor: false
    }
