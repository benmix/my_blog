...
tags:
  ...
  - learning
  - notes
duration: 2023-02-21 to 2023-03-12
public_date: 2023-02-21
...
![The spiral of success](/content_images/64736278541b274d8656ae270865dac8.png)
...
- 按测试粒度和测试范围进行测试类型划分：
![测试类型按粒度进行划分](/content_images/477092ef052ccd91b89523072a38b98d.png)
- 小型测试（单元测试）：
...
- 测试的范围百分比划分：
![单元测试、集成测试、端对端测试的建议占比](/content_images/903b87167a5b41376ff5f1879ca0a954.png)
- 测试分布反模式：
![](/content_images/798b13a0befc6b65919db55952582e59.png)
...
![](/content_images/c6329c8a12ebee41d3b63fdb5f4c8b6a.png)
...
- 分布式构建
    - 远程缓存
![A distributed build showing remote caching](/content_images/c165955f132cdaeda929241ac1ba0cf2.png)
    ...
    - 远程执行
![A remote execution system](/content_images/a54d595ab6dfaa0ccd3787eb0debab66.png)
...
- 谷歌分布式构建系统
![](/content_images/bf17914471e835db0150f52f6742a1b0.png)
    - ObjFS 远程缓存服务
        - 提供按需下载和预览功能。
    - Forge 远程构建系统
...
- 基于制品的构建系统的依赖管理
    - 内部依赖
        ...
        - 传递依赖：
![Transitive dependencies](/content_images/b38162e2b5a75e425c11ff5a8ac68d37.png)
...
- 依赖冲突和菱形依赖
![The diamond dependency problem](/content_images/d67eb85c29083d7d55d51cf0200015e5.png)
...
- 快速反馈循环
    - 软件生命周期
![Life of a code change](/content_images/5a7514e0cbc278bd4c52b979c6b12f69.png)
...
- 持续测试
![Life of a code change with CB and CD](/content_images/5dd8952e8ccada1005c697ffb4b22abc.png)
    - 预提交和提交后
        - 不在预提交上运行自动化测试的原因：
